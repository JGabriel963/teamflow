import arcjet, { createMiddleware, detectBot, withArcjet } from "@arcjet/next";
import {
...
const aj = arcjet({
  ...
  rules: [
    detectBot({
      mode: "LIVE",
      allow: ["CATEGORY:SEARCH_ENGINE", "CATEGORY:PREVIEW", "CATEGORY:WEBHOOK"],
    }),
  ],
});
