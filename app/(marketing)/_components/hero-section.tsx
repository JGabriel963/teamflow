...
import HeroDark from "@/public/scheenshots.png";
import HeroLight from "@/public/scheenshots-2.png";
          ...
          <div className="relative pt-24 md:pt-36">
            ...
            <div className="mx-auto max-w-7xl px-6">
              <div className="text-center sm:mx-auto lg:mr-auto lg:mt-0">
                ...
                >
                  TailFlow organizes conversaations into channels wiith threads,
